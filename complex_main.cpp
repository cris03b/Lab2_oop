...
void test_add() {
    ...
    c2.setImaginary(4);
    rez = c1 + c2;
    assert(rez.getReal() == 2);
    assert(rez.getImaginary() == 7);
...
void test_mult() {
    ...
    c2.setImaginary(4);
    rez = c1 * c2;
    assert(rez.getReal() == -10);
    assert(rez.getImaginary() == 10);
}
...
void test_quot() {
    ...
    c2.setImaginary(4);
    rez = c1 / c2;
    assert(rez.getReal() == 0.7);
    assert(rez.getImaginary() == 0.1);
}
...
void test_polar() {
    ...
    c1.setReal(1);
    c1.setImaginary(3);
    assert(c1.ComputePolar() == 71.5650512);
}
